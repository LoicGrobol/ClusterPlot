...
class PolygonsGenerator:
    ...
    def preprocess_polygons(self, polys, title="", num_outliers=0, make_plots=False):
        ...
        for i in range(len(polys)):
            dp = True
            if dp:
                polys[i][PolygonsGenerator.SMOOTH_POLY] = np.array(
                    self.smooth_poly_Douglas_Peucker(polys[i][PolygonsGenerator.POLY])
                )
            else:
                polys[i][PolygonsGenerator.SMOOTH_POLY] = np.array(
                    self.smooth_poly_Chaikins_corner_cutting_iter(polys[i][PolygonsGenerator.POLY])
                )
            ...
            #     polys[i][PolygonsGenerator.POLY]))
            #
            polys[i][PolygonsGenerator.INNER_POINTS] = np.array(
                PolygonsGenerator.random_points_inside_polygon_and_3d(
        ...
        if make_plots:
            ...
            for i in range(len(polys)):
                ...
                fig.add_trace(
                    go.Scatter(
                        x=polys[i][PolygonsGenerator.INNER_POINTS][:, 0],
        ...
        for i, poly in enumerate(polys):
            ...
            feature_cols = [
                PolygonsGenerator.X_COL,
                PolygonsGenerator.Y_COL,
                PolygonsGenerator.Z_COL,
            ]
    ...
    def get_polygons(polygons_name):
        ...
        if polygons_name == "fists_no_overlap":
            polys = [
                {
                    ...
                    PolygonsGenerator.SMOOTH_POLY: None,
                    PolygonsGenerator.INNER_POINTS: None,
            ...
            polys = [
                ...
                {
                    PolygonsGenerator.POLY: [[1, 2], [3, 4], [5, 2], [3, 0], [1, 2]],
                    PolygonsGenerator.SMOOTH_POLY: None,
                    PolygonsGenerator.INNER_POINTS: None,
            ...
            polys = [
                {
                    PolygonsGenerator.POLY: [[0, 2], [3, 6], [7, 2], [3, -2], [0, 2]],
                    PolygonsGenerator.SMOOTH_POLY: None,
                    PolygonsGenerator.INNER_POINTS: None,
                    PolygonsGenerator.Z_DIST: (0, 1),
                },
                {
                    PolygonsGenerator.POLY: [[2.9, 2], [3, 3.1], [3.1, 2], [3, 2.9], [2.9, 2]],
                    PolygonsGenerator.SMOOTH_POLY: None,
                    PolygonsGenerator.INNER_POINTS: None,
            ...
            polys = [
                {
                    PolygonsGenerator.POLY: [[1, 2], [3, 4], [3, 0], [1, 2]],
                    PolygonsGenerator.SMOOTH_POLY: None,
                    PolygonsGenerator.INNER_POINTS: None,
                    PolygonsGenerator.Z_DIST: (0, 0.1),
                },
